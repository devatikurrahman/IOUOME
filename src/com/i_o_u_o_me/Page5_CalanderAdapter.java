...
public class Page5_CalanderAdapter extends BaseAdapter {
    ...
    public Page5_CalanderAdapter(Context c, Calendar monthCalendar) {
    	month = monthCalendar;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(days[position].equals("")) {
        	...
        	if(dayNumber > 0) {
	        	...
	        	//Log.d("current date:", "day: "+dayNumber+ " #month: "+this.monthNames[this.currentMonth]+ 
	        		//" #year: "+ this.currentYear);
	        	
	        	Cursor getDataCursor = MainActivity.db.getExpenseInfo(Integer.toString(dayNumber), 
	        			this.monthNames[this.currentMonth], Integer.toString(this.currentYear));
	        	if (getDataCursor.moveToFirst()) {
	        		
	        		//Log.d("#### Name : ", " "+ getDataCursor.getString(getDataCursor.getColumnIndex("Name")));
	        		//Log.d("#### Ammount : ", " "+ getDataCursor.getString(getDataCursor.getColumnIndex("Ammount")));
	        		//Log.d("#### Day : ", " "+ getDataCursor.getString(getDataCursor.getColumnIndex("Day")));
