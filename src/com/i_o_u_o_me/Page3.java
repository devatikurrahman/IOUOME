...
public class Page3 extends Fragment implements OnClickListener {
	public static String FRAGMENT_TAG = "Page3";
	View rootview;
	...
	public void initViewsAndUtils() {
		MainActivity.top_bar_text.setText("Shift calendar");
	    ...
	    gridview.setOnItemClickListener(new OnItemClickListener() {
		    public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
		        ...
		        if(date instanceof TextView && !date.getText().equals("")) {
					...
					MainActivity.mFragmentManager.beginTransaction().replace(R.id.frame, new WeekFragement(), 
							WeekFragement.FRAGMENT_TAG).addToBackStack(null).commit();
